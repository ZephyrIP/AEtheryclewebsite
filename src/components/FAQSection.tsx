      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={categoryIndex}>
              ...
              <div className="space-y-4">
                {category.faqs.map((faq, faqIndex) => {
                  ...
                  return (
                    <div key={globalIndex} className="border border-gray-700 bg-gray-900 rounded-lg overflow-hidden">
                      <button
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="border border-gray-700 text-white px-6 py-3 font-mono text-sm hover:bg-gray-800 transition-colors">
              JOIN DISCORD
            </button>
            <button className="border border-gray-700 text-white px-6 py-3 font-mono text-sm hover:bg-gray-800 transition-colors">
              VIEW DOCS
